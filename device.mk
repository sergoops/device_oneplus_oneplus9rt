...
# Audio
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/configs/audio/audio_io_policy.conf:$(TARGET_COPY_OUT_ODM)/etc/audio/sku_lahaina/audio_io_policy.conf \
    $(LOCAL_PATH)/configs/audio/audio_io_policy.conf:$(TARGET_COPY_OUT_VENDOR)/etc/audio/sku_lahaina/audio_io_policy.conf \
    $(LOCAL_PATH)/configs/audio/audio_effects.xml:$(TARGET_COPY_OUT_ODM)/etc/audio/sku_lahaina/audio_effects.xml \
...
PRODUCT_PACKAGES += \
    android.hardware.sensors@2.1-service.oneplus9rt-multihal \
    libsensorndkbridge \
    sensors.oneplus9rt
